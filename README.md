...
2. [Download chatalysis in a zip folder](https://github.com/stepva/chatalysis/archive/refs/tags/v1.1.0.zip) and extract it wherever you want to.
...
```
    python Desktop/chatalysis-1.1.0/chatalysis
```
